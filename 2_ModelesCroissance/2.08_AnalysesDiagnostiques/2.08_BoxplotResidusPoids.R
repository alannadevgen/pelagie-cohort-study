...
# Boxplots des residus des meilleurs modeles pour le poids
...
ResidusJenssBayley <- JenssBayleyPoidsPop@results@icwres
ResidusJenssModifie <- JenssModifiePoidsPop@results@icwres
ResidusReed1erOrdre <- Reed1erOrdrePoidsPop@results@icwres
ResidusReed2ndOrdre <- Reed2ndOrdrePoidsPop@results@icwres
...
pdf("Graphiques/Poids/BoxplotResidusPoidsAnnees.pdf", paper = "a4r", width = 11, height = 10)
multiplot(title = "Résidus standardisés des quatre modèles candidats pour le poids",
          plotJenssBayleyAgeAnnees,
          plotReed1erOrdreAgeAnnees,
          plotJenssModifieAgeAnnees,
          plotReed2ndOrdreAgeAnnees,
