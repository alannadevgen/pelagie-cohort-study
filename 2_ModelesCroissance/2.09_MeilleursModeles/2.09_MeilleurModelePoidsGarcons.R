...
best.fit <- JenssModifiePoidsGarcons
...
pdf("Graphiques/Poids/PredictionsIndividuellesJenssAdaptePoidsGarcons.pdf", paper = "a4r", width = 11, height = 10)
...
pdf("Graphiques/Poids/ScatterResidualsJenssAdaptePoidsGarcons.pdf", width = 12, height = 10)
ggplot(data = residus) +
  theme_minimal() +
