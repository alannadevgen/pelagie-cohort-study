saemixReed2 <- function(
  ...
  model <- saemixModel(
    model = modSaemixReed2,
    description = paste0("Modele Reed du 2nd ordre - ", str_to_title(variable_anthropometrique)),
  ...
  saemix.fit <- saemix(
    ...
    control = list(seed = 632545,
                   ...
                   directory = paste0("Graphiques/", str_to_title(variable_anthropometrique), "/GraphiquesReed2ndOrdre", str_to_title(sexe))
                   )
  )
