saemixReed1 <- function(
  ...
  model <- saemixModel(
    model = modSaemixReed1,
    description = paste0("Modele Reed du 1er ordre - ", str_to_title(variable_anthropometrique)),
  ...
  saemix.fit <- saemix(
    ...
    control = list(seed = 632545,
                   ...
                   directory = paste0("Graphiques/", str_to_title(variable_anthropometrique), "/GraphiquesReed1erOrdre", str_to_title(sexe))
                   )
  )
